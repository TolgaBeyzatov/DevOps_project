...
# Define the path for counter file to store the data in Docker Volume. 
COUNTER_FILE = "/data/postcount.txt"
...
def health_check():
    ...
    Returns: 
        tuple: A JSON response indicating the health status and the HTTP status.
    """
    try: 
...
if __name__ == '__main__':
    # Run the Flask app with binding all interfaces on port 8080.
